...
public class Objects extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    EditText KeyWord;
    String HomeName;
    String[] wall_list = {"Left Wall Object", "Right Wall Object", "Front Wall Object", "Back Wall Object", "Floor Wall Object", "Ceiling Wall Object"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "Sigmaway/"+HomeName+File.separator+Room_Selected+File.separator+"Objects");
            ...
            public void onClick(View v) {
                ...
                try {
                    if (gridviewid==0.1)
                    {
                        ...
                        //used replace as the uri get %20 in place of a space bar when passed
...
// no camera on this device
    ...
    private File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), IMAGE_DIRECTORY_NAME+File.separator+HomeName+File.separator+Room_Selected+File.separator+"Objects");
